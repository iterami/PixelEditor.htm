...
function repo_init(){
    core_repo_init({
      ...
      'storage-menu': '<table><tr><td><input id=height min=1 step=any type=number><td>Height'
        ...
        + '<tr><td><input id=quality max=1 min=0 step=any type=number><td>Quality'
        + '<tr><td><input id=size min=1 step=any type=number><td>px Size'
