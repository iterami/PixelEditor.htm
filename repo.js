...
function hover_pixel(pixel){
    core_elements.color_hover.value = pixel.textContent === 'T'
      ? 'transparent'
...
function update_pixel(pixel, result){
    ...
    if(core_storage_data.mode === 1){
        ...
        pixel.textContent = 'T';
        core_elements.color_hover.value = 'transparent';

    }else{
        pixel.style.backgroundColor = core_elements.color.value;
        pixel.textContent = '';
        core_elements.color_hover.value = rgb_to_hex(pixel.style.backgroundColor);
    }
